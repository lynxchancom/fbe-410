...
/*			if(array_key_exists($post_board, unserialize(KU_FLAGBOARDS))) {
				...
				{
					$buildpost_output .= sprintf("<a href=\"#\" onclick=\"javascript:translate('%d'); return false;\">Lolšto?</a>", $post['id']);
				}
			} */
...
//					$output .= '<option value="'.ucfirst($stylesheet).'" onclick="set_stylesheet(\'' . ucfirst($stylesheet) . '\');return false;">' . ucfirst($stylesheet) . "</option>\n";
		...
		if(in_array($this->board_dir, CONGLOMERATE)){
			$output .= '<div class="iichanbar"> <a href="//iichan.hk/">Ычан:</a> [<a href="//iichan.hk/d/" title="работа сайта | site discussion">d</a> |  <a href="//iichan.hk/b/" title="бред | random">b</a> / <a href="//iichan.hk/bro/" title="my little pony">bro</a> / <a href="//iichan.hk/gf/" title="gif- и flash-анимация | gif and flash animation">gf</a> / <a href="//iichan.hk/hr/" title="высокое разрешение | high resolution">hr</a> / <a href="//iichan.hk/l/" title="литература | literature">l</a> / <a href="//iichan.hk/m/" title="макросы/копипаста | macros/copypasta">m</a> / <a href="//iichan.hk/med/" title="медицина | medicine">med</a> / <a href="//iichan.hk/mi/" title="оружие | weapons">mi</a> / <a href="//iichan.hk/mu/" title="музыка | music">mu</a> / <a href="//iichan.hk/o/" title="рисование | artwork">o</a> / <a href="//iichan.hk/ph/" title="фото | photo">ph</a> / <a href="//iichan.hk/r/" title="просьбы | requests">r</a> / <a href="//iichan.hk/s/" title="электроника и по | electronics and software">s</a> / <a href="//iichan.hk/sci/" title="наука | science">sci</a> / <a href="//iichan.hk/tran/" title="иностранные языки | foreign languages">tran</a> / <a href="//iichan.hk/tv/" title="кино, тв и мультфильмы | films, tv and cartoons">tv</a> / <a href="//iichan.hk/x/" title="паранормальные явления | paranormal">x</a> |  <a href="//iichan.hk/vg/" title="видеоигры | videogames">vg</a> | <a href="//iichan.hk/au/" title="автомобили | automobiles">au</a> / <a href="//iichan.hk/tr/" title="транспорт | transport">tr</a> | <a href="//iichan.hk/a/" title="аниме и манга | anime and manga">a</a> / <a href="//iichan.hk/aa/" title="аниме-арт | anime art">aa</a> / <a href="//iichan.hk/c/" title="косплей | cosplay">c</a> / <a href="//iichan.hk/fi/" title="фигурки | figurines">fi</a> / <a href="//iichan.hk/jp/" title="япония | japan">jp</a> / <a href="//iichan.hk/rm/" title="rozen maiden">rm</a> / <a href="//iichan.hk/tan/" title="сетевые персонажи | net characters">tan</a> / <a href="//iichan.hk/to/" title="touhou">to</a> / <a href="//iichan.hk/vn/" title="визуальные новеллы | visual novels">vn</a>]</div>';
		}
		if ($this->board_type == 0 || $this->board_type == 2 || $this->board_type == 3) 
		{
// banner
...
//					'		<input type="text" name="em" size="28" maxlength="75" accesskey="e">&nbsp;' .
					'<label for="sage">[<input id="sage" type="checkbox" name="sage">säge]</label>&nbsp;' . 
					'<label for="noko">[<input id="noko" type="checkbox" name="noko">nöko]</label>' . "\n" .
					'	</td>' . "\n" .
					'</tr>'. "\n"; */
					if ($this->board_enablecaptcha == 1) {
						$output .= '<tr>' . "\n" .
