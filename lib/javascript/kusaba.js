...
function expandThis(linkEl, mode){
   ...
   if( $.inArray(fullSrcExt, imageExtensions) > -1 ){
      ...
      if( $img[0].src.includes('/thumb/') ){
         ...
         // full → thumb, unless triggered by “Expand all images”
      ...
      if( mode === 'all' ) return false; // ignore “Expand all images”
   ...
   } else return mode !== 'all'; //ignore “Expand all images” (mode==='all'),
