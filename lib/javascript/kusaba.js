   ...
   if( $.inArray(fullSrcExt, imageExtensions) > -1 ){
      ...
      if( $link.data('videoMode') === 'on' ){
         ...
         $link.after($player).data({
            videoPlayer: $player,
            thumbHTML: $link.html()
         }).html('<div class="hidevideo"><img src="/css/icons/blank.gif" class="hidebutton" alt="hide" border="0" title="Свернуть"></div>');
      }
      ...
      if( $link.data('audioMode') === 'on' ){
         ...
         $link.after($player).data({
            audioPlayer: $player,
            thumbHTML: $link.html()
         }).html('<div class="hideaudio"><img src="/css/icons/blank.gif" class="hidebutton" alt="hide" border="0" title="Свернуть"></div>');
      }
