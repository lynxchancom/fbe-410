      ...
      function(idx, input) {
        ...
        if (targetForm) {
          ...
          if (sourceFormId && targetFormId) {
            $(document).on('keyup focus', '#'+sourceFormId+' [name='+inputName+']', function() { $('[name='+inputName+']', targetForm).val($(input).val());  } );
          }
        } else {
          if (sourceFormId) $(document).off('keyup focus', '#'+sourceFormId+' [name='+inputName+']');
        }
      }
    );
  }
