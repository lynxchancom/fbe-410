...
function QuickReplyForm(replyFormId, replyThreadInputName, quickReplyFormId, quickReplyFormClass, quickReplyFormHeaderClass, threadClass, omittedRepliesClass, replyClass, buttonsContainerClass, quickReplyButtonClass) {
  ...
  function _createQuickReplyForm(sourceForm) {
    ...
    targetFormReplyThreadIndicator = targetFormCloseButton.attr('onclick', 'return false');
...
$(function(){
   ...
   if (typeof QuickReplyForm !== 'undefined') {
     quickReplyForm = QuickReplyForm('postform', 'replythread', 'quickreplypostform', 'quick-reply-form', 'replymode', 'thrdcntnr', 'omittedposts', 'reply', 'extrabtns', 'post-btn-reply');
     quickReplyForm.init();
   }
