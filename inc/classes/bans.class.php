		...
		if ($force_display) {
			...
			if (count($results)>0) {
				foreach($results AS $line) {
					...
					echo '<title>'._gettext('Banned!').'</title><div align="center"><img src="'.KU_BOARDSPATH.'/youarenotbanned.jpg" alt="You are banned"/><br><br>'._gettext('You have been banned for: <b>'). $line['reason'] . '</b><br/><br/>If no reason is specified please contact the administrator.</div>';
				}
			}
		} else {
			return true;
